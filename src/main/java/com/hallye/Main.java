...
import com.hallye.config.guice.EventListenerScanner;
import com.hallye.config.guice.HandlerScanner;
...
import com.hallye.config.jetty.JettyModule;
import com.hallye.config.ResourceConfigModule;
import com.hallye.config.RestEasyServletModule;
import com.hallye.config.swagger.SwaggerModule;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            final Injector injector = Guice.createInjector(new JettyModule(), new RestEasyServletModule(APPLICATION_PATH),
                    new ResourceConfigModule(), new SwaggerModule(APPLICATION_PATH));

            injector.getInstance(Main.class).run();
        } catch (Throwable t) {
            Log.getLogger(Main.class).info(t);
        }
    }
